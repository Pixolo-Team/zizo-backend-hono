...
// VALIDATORS //
import { verifyOtpRequestSchema, loginRequestSchema, checkUserByPhoneSchema } from '@/validators/auth.validator';

// SERVICES //
import { verifyOtpService, loginService, checkUserByPhoneService } from '@/services/auth.service';
