...
/**
 * Route definition for POST /invites/get-user-invites
 */
...
/**
 * Route definition for POST /invites/create
 */
...
/**
 * Route definition for POST /organization-invites/respond
 */
export const respondToInviteRoute = createRoute({
  method: 'post',
