...
/**
 * Zod Schema for request body of Respond to Invite API Endpoint
 */
...
/**
 * Zod Schema for the response of Respond to Invite API Endpoint
 */
...
/**
 * TypeScript type inferred from the RespondToInviteResponseSchema
 */
